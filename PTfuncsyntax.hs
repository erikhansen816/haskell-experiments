...
windChillRisk t v
  | windTemp >= 16 = "Low Risk"
  | windTemp >= -17 = "Moderate Risk"
  | windTemp >= -38 = "High Risk"
  | windTemp >= -53 = "Very High Risk"
  | windTemp >= -65 = "Severe Risk"
  | otherwise  = "Extreme Risk"
  where windTemp = (35.74 + 0.6215*t - 35.75*v**0.16 + 0.4275*t*v**0.16)
